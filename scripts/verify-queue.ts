...
async function main() {
  ...
  // The "Open in PrusaSlicer" bridge is a bare byd:// link the story page
  ...
  check("the story page offers Open in PrusaSlicer",
        storyPage.includes(`byd://slice/${regret.id}`),
        "the byd:// bridge link is missing or has the wrong id");
